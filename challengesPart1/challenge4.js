...
Your tasks:
1.
Calculate the tip, depending on the bill value. Create a variable called 'tip' for this. It's not allowed to use an if/else statement 😅 (If it's easier for you, you can
...
console.log(`The bill costed ${bill} and the tip was ${tip}, so the final cost was ${bill + tip}.`);

/*
if (bill >= 50 && bill <= 300) {
    console.log(`The tip would cost ${ bill * .20}`)
}
*/
